  ...
  return (
    <section className="relative w-full h-screen bg-[#111111] overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        <Image
          src="/hero/experience/experiencehero.jpg"
          alt="Lion Hotel Çınarcık'ta premium butik otel deneyimi"
          fill
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-16 relative z-30 h-full flex items-center justify-start max-w-7xl">
        <div className="max-w-5xl text-[#FFFFFF]">
          ...
          <Reveal>
            ...
            >
              Şehrin Ritmini <br />
              <span className="italic font-normal text-white/95">Yavaşlatın</span>
            </h1>
          </Reveal>

          <Reveal>
            <p className="mt-8 max-w-2xl text-[14px] font-light leading-[1.75] text-white/90 sm:text-[16px]">
              Çınarcık&apos;ın merkezinde; denize yakın, zamansız ve sakin bir butik otel deneyimi. Her detay, konaklamadan fazlasını hissettirmek için yalınlaştırıldı.
            </p>
          </Reveal>
